...
let embed = new Discord.MessageEmbed().setFooter("Sentrius tarafından geliştirildi.", message.author.avatarURL({dynamic: true})).setColor("010000").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
